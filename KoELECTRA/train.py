...
from transformers import Trainer, TrainingArguments, ElectraForSequenceClassification, ElectraTokenizer, ElectraConfig
...
def train():
  ...
  train_dataset, dev_dataset = torch.utils.data.random_split(RE_train_dataset, [7000, 2001])
  ...
  model = ElectraForSequenceClassification.from_pretrained(MODEL_NAME, config=bert_config) 
  #model.parameters
  model.to(device)
